...
import api.hud.base.AbstractWindow;
import api.hud.base.DefaultUIValues;
import api.hud.base.WindowSize;
import api.hud.manager.alert.Drag;
import api.hud.manager.alert.Exit;
import api.hud.manager.alert.ResizeBottom;
import api.hud.manager.alert.ResizeComponent;
import api.hud.manager.alert.ResizeLeft;
import api.hud.manager.alert.ResizeRight;
import api.hud.manager.alert.ResizeTop;
...
public class CustomAlert extends JDialog implements AbstractWindow {
	 ...
	 */
	public void setExitListener(api.hud.manager.window.Exit listener) {
		for (ActionListener e : this.close.getActionListeners()) {
			if (e instanceof api.hud.manager.window.Exit) {
