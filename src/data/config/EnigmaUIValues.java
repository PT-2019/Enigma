...
public interface EnigmaUIValues {
	...
	Font ENIGMA_TITLE_FONT = new Font("Monospaced", Font.BOLD, 40);
	...
	Color ENIGMA_BUTTON_HOVERED_FOREGROUND = Color.RED;
	Color ENIGMA_BUTTON_PRESSED_FOREGROUND = Color.RED;
	Color ENIGMA_BUTTON_BORDER = Color.WHITE;
	Color ENIGMA_BUTTON_HOVERED_BORDER = Color.RED;
	Color ENIGMA_BUTTON_PRESSED_BORDER = Color.RED;
