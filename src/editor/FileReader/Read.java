...
public class Read {
     ...
     */
    @SuppressWarnings("unchecked")
    public static ArrayList<Object> startReading(String filePath) throws IOException, NoSuchMethodException, InterruptedException, IllegalAccessException, InstantiationException, InvocationTargetException, ClassNotFoundException {
