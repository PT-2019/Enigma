...
import editor.menus.enimas.viewer.EnigmaView;
import editor.menus.enimas.viewer.OperationPanel;
import editor.menus.enimas.viewer.Operations;
 ...
 * @version 5.0
 * @see EnigmaView
 * @see editor.menus.enimas.viewer.OperationPanel
 * @since 4.2
 */
