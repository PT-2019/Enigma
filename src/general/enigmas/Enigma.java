...
/**
 * Enigma gère une énigme. Une énigme est définie par les {@link general.enigmas.condition.Condition conditions} à satisfaire pour résoudre l'énigme ainsi que les
 * {@link general.enigmas.operation.Operation opérations} réalisées si toutes les conditions sont satisfaites.
 * Une énigme contient aussi des {@link general.enigmas.Advice indices} déstinés aux joueurs.
 *
